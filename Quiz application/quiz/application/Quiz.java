...
public class Quiz extends JFrame implements ActionListener{
    ...
    public static int ans_given=0;   //to check if ans is given
    ...
    Quiz(String name){
        ...
        setLayout(null);
         ...
         //image
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/quiz.jpg"));    //to load image
        ...
        next.setBackground(new Color(153,0,76));
        next.setForeground(Color.WHITE);
        next.addActionListener(this);
        add(next);
        
        lifeline=new JButton("50-50 Lifrline");
    ...
    public void paint(Graphics g){
        ...
        String time="Time Left "+timer+" seconds";  //initial 20
